...
denom_g = tc*(crt + ((1+rt)*(eft + bft_1) - p*grid_f')) - bgt_1 + p*grid_f';
num_g = (tc*(crt1 + ((1+rt1).*(repmat(e.f,1,l_grid_f) + repmat(grid_f,n_states,1)) - zt1.*qt1.*bft1)) - ...
    repmat(grid_f,n_states,1) + qt1.*zt1.*bgt1);
