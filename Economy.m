classdef Economy
    ...
    methods
        ...
        function obj = update(obj, nworkers)
            ...
            obj.cr = (1/(1+obj.tc))*(obj.Ar + (1+obj.r).*obj.kr...
                + obj.w - obj.q.*obj.br);
            obj.cr(obj.cr<0) = 0;
            
            obj.cf = (1/(1+obj.tc))*(obj.Af + (1+obj.r).*obj.kf...
                - obj.q.*obj.bf);
            obj.cf(obj.cf<0) = 0;
        ...
        function [p_s, br_s, bf_s, bg_s, z_s] = Solution(obj, n, id_br, id_bf)
            ...
            function [fval, p_s, br_s, bf_s, bg_s] = welfare(z)
                ...
                cr_s = (1/(1+obj.tc))*(obj.Ar + (1+r_s).*kr_s...
                    + w_s - p_s.*br_s);
                cr_s(cr_s<0) = 0;
                
                cf_s = (1/(1+obj.tc))*(obj.Af + (1+r_s).*kf_s...
                    - p_s.*bf_s);
                cf_s(cf_s<0) = 0;
